...
var loader$i = async () => {
  const { diagram } = await import("./c4Diagram-2ae3841a-MOKGC3IU.js");
...
var loader$h = async () => {
  const { diagram } = await import("./flowDiagram-ee152de2-CPX3UZK4.js");
...
var loader$g = async () => {
  const { diagram } = await import("./flowDiagram-v2-566a30e4-GNT7Y3ND.js");
...
var loader$f = async () => {
  const { diagram } = await import("./erDiagram-508b3995-CJZ7CPOB.js");
...
var loader$e = async () => {
  const { diagram } = await import("./gitGraphDiagram-e326c88e-P3GQEIT2.js");
...
var loader$d = async () => {
  const { diagram } = await import("./ganttDiagram-18b8bb1d-JLKBMFTV.js");
...
var loader$b = async () => {
  const { diagram } = await import("./pieDiagram-00db3e06-YNC7E2YM.js");
...
var loader$a = async () => {
  const { diagram } = await import("./requirementDiagram-61f3cb14-D7ACTAFP.js");
...
var loader$9 = async () => {
  const { diagram } = await import("./sequenceDiagram-2682829a-7ZATKASM.js");
...
var loader$8 = async () => {
  const { diagram } = await import("./classDiagram-58722808-PP6USSYD.js");
...
var loader$7 = async () => {
  const { diagram } = await import("./classDiagram-v2-4cc74290-XMTD5KDQ.js");
...
var loader$6 = async () => {
  const { diagram } = await import("./stateDiagram-224b91ac-X2KPSHTY.js");
...
var loader$5 = async () => {
  const { diagram } = await import("./stateDiagram-v2-03fb723d-RIR36CBG.js");
...
var loader$4 = async () => {
  const { diagram } = await import("./journeyDiagram-37931021-3KNCXLN4.js");
...
var loader$2 = async () => {
  const { diagram } = await import("./flowchart-elk-definition-99086e81-B2HEY4JR.js");
...
//# sourceMappingURL=chunk-2Y4R5XW7.js.map
